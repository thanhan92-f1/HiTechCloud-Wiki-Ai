...
const STORAGE_KEY = 'hitechcloud_widget_session';
...
export class HiTechCloudWidget {
  ...
  async mount() {
    ...
    this.root.id = 'hitechcloud-widget-root';
  ...
  private async initSession() {
    try {
      ...
      console.warn('[HiTechCloudWidget] Init failed, will retry on open:', err);
    }
  }
  ...
  private async handleSend() {
    ...
    try {
      ...
      console.error('[HiTechCloudWidget] Send error:', err);
    } finally {
