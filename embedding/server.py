...
Provides /embed and /embed/batch endpoints compatible with hitechcloud-wiki-ai backend.
...
app = FastAPI(title="HiTechCloud Wiki Embedding Service", version="1.0.0")
