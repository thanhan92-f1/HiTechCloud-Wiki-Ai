...
async function bootstrap() {
  ...
  // CORS (supports wildcard subdomains like https://*.ai.hitechcloud.one)
  ...
  console.log(`🚀 HiTechCloud Wiki CRM running on http://localhost:${port}`);
